...
def test_scene_renderer():
    # Sample objects
    objects = [
        {'x': 3, 'y': 2, 'color': 'blue', 'shape': 'pentagon'},
        {'x': 1, 'y': 3, 'color': 'yellow', 'shape': 'triangle'},

        {'x': 0, 'y': 0, 'color': 'red', 'shape': 'square'},
        {'x': 4, 'y': 0, 'color': 'yellow', 'shape': 'pentagon'},
        # {'x': 1, 'y': 1, 'color': 'red', 'shape': 'square'},
        # {'x': 0, 'y': 2, 'color': 'red', 'shape': 'square'},

        # {'x': 0, 'y': 1, 'color': 'green', 'shape': 'circle'},
        {'x': 0, 'y': 3, 'color': 'blue', 'shape': 'triangle'},
        {'x': 0, 'y': 4, 'color': 'green', 'shape': 'circle'},
        {'x': 2, 'y': 1, 'color': 'red', 'shape': 'square'}
        # {'x': 1, 'y': 2, 'color': 'green', 'shape': 'square'},
        # {'x': 2, 'y': 1, 'color': 'red', 'shape': 'triangle'},
        # {'x': 2, 'y': 2, 'color': 'yellow', 'shape': 'circle'},
        # {'x': 3, 'y': 0, 'color': 'green', 'shape': 'pentagon'},
        # {'x': 3, 'y': 4, 'color': 'blue', 'shape': 'circle'},
        # {'x': 4, 'y': 1, 'color': 'green', 'shape': 'triangle'},
        # {'x': 4, 'y': 3, 'color': 'yellow', 'shape': 'square'}        
    ]
